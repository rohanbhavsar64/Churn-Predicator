...
for i in range(len(list)):
    ...
    list4.append(b.find_all(class_='ds-bg-fill-content-alternate ds-text-left')[4].text)
    list5.append(b.find_all(class_='ds-bg-fill-content-alternate ds-text-left')[5].text)
