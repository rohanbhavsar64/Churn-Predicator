...
fig = go.Figure(data=[
    go.Scatter(x=df1['over'], y=df1['inng1'], name=df['bowling_team'].unique()[0], line_color='red',line_width=4),
    go.Scatter(x=lf['over'], y=lf['score'], name=df['batting_team'].unique()[0], line_color='green',line_width=4)
])
