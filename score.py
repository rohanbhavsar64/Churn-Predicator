...
# Line plots for batting and bowling teams
batting_team = fig.add_trace(go.Scatter(x=temp_df['end_of_over'], y=temp_df['win'], mode='lines', name='Batting team',line=dict(color='green', width=4)))
bowling_team = fig.add_trace(go.Scatter(x=temp_df['end_of_over'], y=temp_df['lose'], mode='lines', name='Bowling team',line=dict(color='red', width=4)))
fig.update_layout(title='Target-' + str(target))
st.write(fig)
