...
fig = go.Figure(data=[
    go.Scatter(x=df1['over'], y=df1['inng1'],line_width=3,line_color='#650707',name=df['bowling_team'].unique()[0]),
    go.Scatter(x=lf['over'], y=lf['score'],line_width=3,line_color='#095309',name=df['batting_team'].unique()[0])
])
