...
if o==50:
    ...
    fig2 = px.pie(data_frame=lf_grouped, names='over_group', values='runs',text=lf_grouped['runs'],hover_text=[f'R: {r}<br>W: {w}' for r, w in zip(lf_grouped['runs'], lf_grouped['wickets'])],hover_name='over_group')
    st.write(fig2)
gf=df
import pandas as pd
import numpy as np
