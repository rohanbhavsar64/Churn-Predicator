...
for i in range(len(list)):
    ...
    list4.append(b.find_all(class_='ds-w-full ds-table ds-table-md ds-table-bordered ds-border-collapse ds-border ds-border-line ds-table-fixed')[1].text)
    list5.append(b.find_all(class_='ds-w-full ds-table ds-table-md ds-table-bordered ds-border-collapse ds-border ds-border-line ds-table-fixed')[2].text)
