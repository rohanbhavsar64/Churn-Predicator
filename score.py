...
if o==50:
    ...
    fig2 = px.pie(data_frame=lf_grouped, names='over_group', values='runs',custom_data=[lf_grouped['wickets']],hover_name='over_group', hover_data=['runs'])
    fig2.update_traces(textinfo=f'%{hover_data[0]}<br>W: %{custom_data[0]}')
