...
fig = go.Figure(data=[
    go.Scatter(x=df1['over'], y=df1['inng1'], name=df['bowling_team'].unique()[0], line=dict(color='red')),
    go.Scatter(x=df['over'], y=df['score'], name=df['batting_team'].unique()[0], line=dict(color='grren'))
])
